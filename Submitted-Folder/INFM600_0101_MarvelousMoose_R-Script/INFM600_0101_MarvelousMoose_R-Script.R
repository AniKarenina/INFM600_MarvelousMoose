...
y(fun.data=mean_cl_normal,geom="errorbar")

ggplot (crashDataWithFatalities,aes(x=Reason,y=Fatalities))+stat_summary( fun.y = "mean",geom = "bar",position = "dodge")+stat_summar
